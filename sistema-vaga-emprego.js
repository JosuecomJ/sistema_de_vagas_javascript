...
function novaVaga() {
  const nome =prompt("informe no nome da vaga")
  const descricao =prompt("Informe a descrição da vaga")
  const dataLimite = prompt("Informe a data limite (dd/mm/aa)")
...
function excluirVaga() {
  ...
  const vaga = vagas[indice]
  const confirmacao = confirm("Deseja realmente excluir a vaga: " + indice +" Nome " + vaga.nome)
